...
public class CreatePathTest extends BaseTest {
	...
	public void projectNoNameFieldError () {
		...
		assertTrue(createPath.hasProjectName());
	}
	...
	public void createNewProject() {
		createPath.createBrandNewProjectPath("Project" +randomNumber+ "f", "This is the Default");
	}
	/*COM 121
        "Given a user wants to name a project,
	 ...
	 */
	@Test
	public void createProject_shouldFail_whenProjectNameIsTooLong() {
		createPath.attemptToCreateProjectNameTooLong("12345678901234567890123456789012345678901", "This is the Default");
		assertEquals("40 characters max",createPath.projectFieldError());
	}
	 ...
	 */
	@Test
	public void createProject_shouldFail_whenProjectNameContainsInvalidCharacters() {
		createPath.attemptToCreateProjectNameTooLong("!@#$%^&*()", "This is the Default");
		assertEquals("Characters must be A-Z 0-9 ( ) # _ - / & or (space)",createPath.projectFieldError());
	}
	...
	public void valProject_ValidChar() {
		createPath.attemptToCreateProject("a-zA-Z0-9s-"+ randomNumber, "This is the Default");
		assertTrue(createPath.landedOnPathSummaryPage());
	}
